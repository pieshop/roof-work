...
This comparison also uses non-PDF context from recent contractor conversations and emails, including remembered Building Control/payment comments and South Thames' verbal view on the gable wall. Treat those as follow-up items unless confirmed in writing.
...
- South Thames' verbal view was that the gable wall may be a non-issue because no wall cracks were visible.
...
- Auletta's rebuild allowance boundaries and structural specification need confirmation; confirm wall-tie extent and materials against the White & Lloyd recommendation.
- None of the three clearly confirms the complete White & Lloyd purlin bearing/support remedy. South Thames' 4x2 supports are not a specified purlin repair.
...
- Compare ridge fixing, maintenance and guarantee implications; Auletta's mortar-bedded main ridge differs from the other two.
- Confirm South Thames' valley and neighbour-junction scope, and Roofcraft's flashing scope to any retained stack.
- Rainwater goods remain unresolved across all quotes.
- Auletta needs written guarantee detail.
...
Roofcraft and South Thames are currently around **£21k-£22k including VAT** for a base slate reroof/chimney package. Those prices should not be treated as complete whole-project prices because the structural/rainwater scope is unresolved. Roofcraft will not quote structural gable/wall-tie work until the roof is removed and the area can be properly inspected. South Thames appears similar on not pricing that work upfront, but verbally suggested the gable wall may be a non-issue because the wall itself had no cracks.
...
- Jack Auletta: Matthew verbally said roof replacement does not legally require Building Regulations sign-off, but the quote says roofing work will be in accordance with NFRC and current Building Regulations.
...
None of the three quotes clearly includes checking/correcting gutters, downpipes, gullies or drainage discharge against the flank wall. This remains a gap against `job-description.txt`.

### Materials

South Thames gives the clearest slate size/grade: Grade A natural slate, 500x250mm. Jack Auletta gives size but not grade/origin. Roofcraft gives natural grey slate but not size, grade or origin.

Ask all three for slate supplier/origin, grade, warranty and expected lifespan.
...
Do not appoint anyone solely on headline price. Roofcraft and South Thames have already been asked about the structural scope and have not produced a written whole-package structural price. Jack Auletta is currently the only quote that directly prices the gable wall rebuild/wall-tie-related building work.

The next useful comparison is:

- Whether Jack Auletta's remaining clarifications on structural approvals, allowance boundaries, purlin, rainwater, certification, guarantees and contract/payment terms are acceptable.
